...
public class PermissionController {
    ...
    @PreAuthorize("hasRole('super_admin') or hasAuthority('PERM_role:view') or hasAuthority('PERM_permission:view')")
    public ResponseEntity<ApiResponse<List<Permission>>> listAssignable(@RequestParam String roleCode) {
        return ResponseEntity.ok(ApiResponse.ok(permissionService.listAssignableToRole(roleCode)));
    }
