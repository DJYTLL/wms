  ...
  <div class="page-shell page-shell--system">
    ...
    <div class="table-card">
      <div class="table-body">
        <ErpDataTable :data="tableData" style="width: 100%" stripe v-loading="loading" :empty-text="$t('table.empty')" table-key="erp-payment-method-management">
...
const allTableData = ref<PaymentMethod[]>([]);
...
const fetchNextCode = async () => {
  try {
    const res: any = await request.get('/erp/payment-methods/next-code');
    if (res.data.code === 200) {
...
const saveData = async () => {
  ...
  try {
    ...
    if (res.data.code === 200) {
      invalidateErpBaseDataResourceCache('paymentMethods', tenantCacheKey.value);
      notifySuccess();
