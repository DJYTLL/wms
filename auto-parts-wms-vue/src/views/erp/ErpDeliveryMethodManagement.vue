  ...
  <div class="page-shell page-shell--system">
    ...
    <div class="table-card">
      <div class="table-body">
        <ErpDataTable :data="tableData" style="width: 100%" stripe v-loading="loading" :empty-text="$t('table.empty')" table-key="erp-delivery-method-management">
...
const fetchNextCode = async () => {
  try {
    const res: any = await request.get('/erp/delivery-methods/next-code');
    if (res.data.code === 200) {
...
const saveData = async () => {
  ...
  try {
    ...
    if (res.data.code === 200) {
      invalidateErpBaseDataResourceCache('deliveryMethods', tenantCacheKey.value);
      notifySuccess();
