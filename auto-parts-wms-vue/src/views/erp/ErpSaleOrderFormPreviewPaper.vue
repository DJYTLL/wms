<template>
  <div class="page-shell sale-preview paper-preview">
    <div class="page-header paper-header">
      <div class="paper-header__title">
        <h2 class="page-title">{{ pageTitle }}</h2>
        <span class="paper-header__badge">{{ $t('status.draft') }}</span>
      </div>
    ...
    <div class="table-card compact-card sale-header-card paper-card">
    ...
    <div class="table-card sale-detail-card paper-card">
    ...
    <div class="table-card compact-card compact-card--inline payment-card paper-card">
...
const pageTitle = computed(() => (isEditing.value ? t('page.erpSaleOrderEdit') : t('page.erpSaleOrderCreatePreviewPaper')));
...
.paper-preview {
  ...
  --paper-shadow: 0 16px 32px rgba(45, 42, 38, 0.12);
...
.paper-header__badge {
  background: rgba(194, 124, 63, 0.16);
...
.paper-hero__strip {
  ...
  inset: 0 auto 0 0;
  width: 6px;
  background: linear-gradient(180deg, var(--paper-accent), var(--paper-accent-deep));
...
.paper-card {
  ...
  border: 1px solid var(--paper-border);
  background: var(--paper-card);
  box-shadow: 0 10px 20px rgba(45, 42, 38, 0.08);
}

.paper-preview .table-card + .table-card {
  margin-top: 16px;
}

.paper-preview :deep(.el-input__wrapper),
.paper-preview :deep(.el-select__wrapper),
.paper-preview :deep(.el-textarea__inner) {
  border-radius: 10px;
  background: #fffaf5;
}

.paper-preview :deep(.el-table) {
  border-radius: 12px;
  overflow: hidden;
}

.paper-preview :deep(.el-table th) {
  background: rgba(45, 42, 38, 0.04);
  color: var(--paper-ink);
}

.paper-preview :deep(.el-table td) {
  background: #fff;
}

.paper-preview :deep(.el-button--primary) {
  background: var(--paper-accent);
  border-color: var(--paper-accent);
}

.paper-preview :deep(.el-button--primary:hover) {
  background: var(--paper-accent-deep);
  border-color: var(--paper-accent-deep);
}

.paper-preview :deep(.el-button--success) {
  background: #b46a32;
  border-color: #b46a32;
}
