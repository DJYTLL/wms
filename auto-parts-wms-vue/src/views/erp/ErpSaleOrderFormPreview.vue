      ...
      <div class="table-body sale-detail-body">
        <div class="detail-section">
          ...
          <div class="detail-table-wrapper">
            <ErpDataTable :data="formData.items" style="width: 100%" border stripe table-key="erp-sale-order-form-preview">
...
const pageTitle = computed(() => t('page.erpSaleOrderCreatePreview'));
...
.detail-table-wrapper :deep(.el-table th) {
  background: rgba(31, 42, 68, 0.04);
}

.detail-table-wrapper :deep(.el-table td) {
  background: #fff;
}
