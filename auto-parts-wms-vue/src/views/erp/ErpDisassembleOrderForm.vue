<template>
  <div class="page-shell page-shell--system sale-page-surface">
      ...
      <div class="table-body sale-detail-body">
        <div class="detail-section">
          ...
          <div class="detail-table-wrapper">
            <ErpDataTable :data="formData.items" style="width: 100%" border stripe :empty-text="$t('table.empty')" table-key="erp-disassemble-order-form">
    ...
    <el-dialog
      ...
      :title="templateDialog.isEditing ? '更新拆分模板' : '保存拆分模板'"
      width="520px"
    >
