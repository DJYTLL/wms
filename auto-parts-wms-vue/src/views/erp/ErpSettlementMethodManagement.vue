  ...
  <div class="page-shell page-shell--system">
    ...
    <div class="table-card">
      <div class="table-body">
        <ErpDataTable :data="tableData" style="width: 100%" stripe v-loading="loading" :empty-text="$t('table.empty')" table-key="erp-settlement-method-management">
          ...
          <ErpDataTableColumn v-if="canShow('fundInputMode')" prop="fundInputMode" label="即时收/付款" min-width="140">
            <template #default="{ row }">
...
const fetchNextCode = async () => {
  try {
    const res: any = await request.get('/erp/settlement-methods/next-code');
    if (res.data.code === 200) {
...
const saveData = async () => {
  ...
  try {
    ...
    if (res.data.code === 200) {
      invalidateErpBaseDataResourceCache('settlementMethods', tenantCacheKey.value);
      notifySuccess();
