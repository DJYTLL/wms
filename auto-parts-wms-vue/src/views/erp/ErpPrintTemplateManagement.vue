<template>
  <div class="page-shell">
    <div class="page-header">
      <h2 class="page-title">{{ $t('page.erpPrintTemplateManagement') }}</h2>
      <div class="table-toolbar">
        <div class="table-filters">
          ...
          />
          <el-select v-model="docTypeFilter" :placeholder="$t('field.docType')" class="table-search" clearable @change="handleSearch">
