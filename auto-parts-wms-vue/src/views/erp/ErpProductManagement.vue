<template>
  <div class="page-shell">
    <div class="page-header">
      <h2 class="page-title">{{ $t('page.erpProductManagement') }}</h2>
      <div class="table-toolbar">
        <div class="table-filters">
          ...
          />
          <el-select v-model="categoryFilter" :placeholder="$t('field.category')" class="table-search" clearable @change="handleSearch">
