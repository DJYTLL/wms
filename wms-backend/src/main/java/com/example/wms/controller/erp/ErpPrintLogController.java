...
public class ErpPrintLogController {
    ...
    @PostMapping
    @PreAuthorize("hasAnyAuthority('PERM_erp-sale:view','PERM_erp-purchase:view','PERM_erp-sale-return:view','PERM_erp-purchase-return:view','PERM_erp-receipt:view','PERM_erp-payment:view','PERM_erp-ar:view','PERM_erp-ap:view','PERM_erp-stock-count:view','PERM_erp-stock-transfer:view','PERM_erp-stock-init:view')")
