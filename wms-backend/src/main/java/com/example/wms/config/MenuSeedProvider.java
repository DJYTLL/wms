...
public final class MenuSeedProvider {
    ...
    public static List<MenuSeed> menuSeeds() {
        return List.of(
            ...
            new MenuSeed("erp-product-fitment", "erp-basic", "车型适配管理", "erp-product-fitment", "/erp/vehicle-fitments", null, "erp-product-fitment:view", 15),
            ...
            new MenuSeed("erp-supplier-type", "erp-basic", "供应商类型", "erp-supplier-type", "/erp/supplier-types", null, "erp-supplier-type:view", 35),
            new MenuSeed("erp-counterparty-subject", "erp-basic", "往来主体管理", "erp-counterparty-subject", "/erp/counterparty-subjects", null, "erp-counterparty-subject:view", 37),
            ...
            new MenuSeed("erp-assemble-order", "erp-warehouse-module", "组装单", "erp-assemble-order", "/erp/assemble-orders", null, "erp-assemble-order:view", 25),
            new MenuSeed("erp-disassemble-order", "erp-warehouse-module", "拆分单", "erp-disassemble-order", "/erp/disassemble-orders", null, "erp-disassemble-order:view", 26),
            ...
            new MenuSeed("erp-finance-customer-debt", "erp-finance", "客户欠款", "erp-finance-customer-debt", "/erp/finance/customer-debts", null, "erp-finance-customer-debt:view", 5),
            ...
            new MenuSeed("erp-finance-counterparty-subject", "erp-finance", "往来主体财务汇总", "erp-finance-counterparty-subject", "/erp/finance/counterparty-subjects", null, "erp-finance-summary:view", 15),
            ...
            new MenuSeed("user", "system", "用户管理", "user", "/users", null, "user:view", 10),
            new MenuSeed("role", "system", "角色权限", "role", "/roles", null, "role:view", 20),
            new MenuSeed("permission", "system", "权限管理", "permission", "/permissions", null, "permission:view", 30),
